...
RDBMS refers to management for databases and SQL is a language

1. Why do tables need a `primary key`?

tables use primary keys for unique ids
...
a third table that holds foreign keys that reference the primary keys on the related tables
